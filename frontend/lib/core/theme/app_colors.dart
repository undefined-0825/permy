...
class AppColors {
  // 背景グラデーション
  static const Color backgroundStart = Color(0xFFE8D4F8);
  static const Color backgroundEnd = Color(0xFFFCE4EC);

  // アクセントカラー
  static const Color primaryPink = Color(0xFFFFB3C1);
  ...
  static const Color highlight = Color(0xFFF3F4F6);
