        ...
        child: Container(
          ...
          child: const Column(
            ...
            children: [
              ...
              _SectionTitle('第2条（取得する情報）'),
              _BulletText('ユーザーが入力したテキスト（返信候補生成に必要な範囲）'),
...
class _ExternalLinkText extends StatelessWidget {
  const _ExternalLinkText({required this.label, required this.url});
